...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
     * Fetches CV data from localStorage (for live preview) or the JSON file.
     */
    async function loadCvData() {
        ...
        try {
            ...
            if (previewDataString) {
                // --- Live Preview Mode ---
                console.log('Live preview data found. Rendering...');
                data = JSON.parse(previewDataString);
                // Clean up localStorage to prevent this data from being used on the next non-preview visit.
